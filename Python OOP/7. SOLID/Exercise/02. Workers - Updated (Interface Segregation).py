...
class LiveWorkers(AbstractWorker):
    @abstractmethod
    def eat(self):
        pass


class RobotWorkers(AbstractWorker):
    pass


class Worker(LiveWorkers):
    def work(self):
        print("I'm normal worker. I'm working.")
...
class Manager:
    ...
    def lunch_break(self):
        if isinstance(self.worker, LiveWorkers):
            self.worker.eat()
